...
const title_config = {
  ...
  y: 180,  // Опущено ниже для баланса композиции
...
const subtitle_config = {
  ...
  y: "h-280"  // Поднято выше для баланса композиции
};
...
**4. Позиционирование:**
```javascript
y: 180        // Верхняя треть экрана - первое что видно в превью
```
