...
API автоматически переносит длинный текст субтитров на 2 строки:
- Расчёт: `max_chars_per_line = 1080 / (fontsize * 0.6)`
- Для `fontsize: 64` → ~16 символов на строку
- Для `fontsize: 48` → ~22 символа на строку
